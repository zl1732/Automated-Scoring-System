...
class LSTM(nn.Module):
    ...
    def __init__(self, rnn_type, vocab_size, embedding_dim, hidden_size, num_layers, dropout=0.2, bidirectional = False):
    ...
    def init_weights(self, opts, pretrained_embedding):
            initrange = 0.1
            if(pretrained_embedding is not None):
                ...
                if opts.use_cuda==1:
                    self.encoder.weight.data = pretrained_embedding.cuda()
                else:
